...
public class CarService {
    ...
    public Car findById(Long id) {
        ...
        PriceClient priceClient = new PriceClient(pricingWebClient.baseUrl(pricingendpoint).build()); //REPLACE THE URL WITH PROPERTY FROM applicaton.properties
